        ...
        result.data.forEach((element, index) => {
          listData += `
            ...
            <tr>
              ...
              <td>
                <div class="buttons">
                ${getCookie("role") == "true" ? `<button class="btn btn-primary btn-sm btn-icon mr-2" id="detailBtn" data-toggle="tooltip" title="Detail"><i class="fas fa-list-alt fa-sm" style=" color:white"></i></button>
                ...
                `<button class="btn btn-primary btn-sm btn-icon mr-2" id="detailBtn" data-toggle="tooltip" title="Detail"><i class="fas fa-list-alt fa-sm" style=" color:white"></i></button>
                <button class="btn btn-info btn-sm btn-icon  mr-1" id="editBTn" data-toggle="tooltip" title="Edit" data-original-title="Edit" onClick="openEditForm(${element.id})"><i class="fas fa-pencil-alt fa-sm" style=" color:white"></i></button>`}
                </div>
              </td>
            </tr>
